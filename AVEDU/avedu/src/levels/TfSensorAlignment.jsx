// src/levels/TfSensorAlignment.jsx
import React, { Suspense, useCallback, useEffect, useMemo, useState } from "react";

// Import slides for Sensor Alignment with TF level
import SensorAlignment from "./slidesTransformations/04-SensorAlignment";
import TransformingData from "./slidesTransformations/05-TransformingData";
import BuildCarWithTF from "./slidesTransformations/06-BuildCarWithTF";
...
const SLIDES = [
  ...
  },
  {
    ...
    Component: BuildCarWithTF,
  },
];

export default function TfSensorAlignment({ onObjectiveHit, onLevelCompleted }) {
