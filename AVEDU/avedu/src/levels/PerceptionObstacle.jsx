// src/levels/PerceptionObstacle.jsx
import React, { Suspense, useCallback, useEffect, useMemo, useState } from "react";

// Import educational slides for this level
import ObstacleDetectionBasics from "./slidesPerception/02-ObstacleDetectionBasics";
import ObstacleDetectionInteractive from "./slidesPerception/02a-ObstacleDetectionInteractive";
...
const SLIDES = [
  {
    ...
    Component: ObstacleDetectionBasics,
  },
  {
    ...
    order: 2,
    objectiveCode: "PERC_OBSTACLE_DETECT",
    Component: ObstacleDetectionInteractive,
  },
];

export default function PerceptionObstacle({ onObjectiveHit, onLevelCompleted }) {
