// src/levels/VdAdvancedDynamics.jsx
import React, { Suspense, useCallback, useEffect, useMemo, useState } from "react";

// Import slides for this level
import SteeringGeometry from "./slidesVehicleDynamics/15-SteeringGeometry";
import Aerodynamics from "./slidesVehicleDynamics/16-Aerodynamics";
import Disturbances from "./slidesVehicleDynamics/17-Disturbances";
import DynamicStability from "./slidesVehicleDynamics/18-DynamicStability";
...
const SLIDES = [
  ...
  },
  {
    ...
    Component: DynamicStability,
  },
];

export default function VdAdvancedDynamics({ onObjectiveHit, onLevelCompleted }) {
