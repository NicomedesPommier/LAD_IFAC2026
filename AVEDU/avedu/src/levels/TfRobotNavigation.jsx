// src/levels/TfRobotNavigation.jsx
import React, { Suspense, useCallback, useEffect, useMemo, useState } from "react";

// Import slides for Robot Navigation Transforms level
import RobotLocalization from "./slidesTransformations/06-RobotLocalization";
import NavigationGoals from "./slidesTransformations/07-NavigationGoals";
import TurtleTfDemo from "./slidesTransformations/08-TurtleTfDemo";
...
const SLIDES = [
  ...
  },
  {
    ...
    Component: TurtleTfDemo,
  },
];

export default function TfRobotNavigation({ onObjectiveHit, onLevelCompleted }) {
