// src/levels/PerceptionTasks.jsx
import React, { Suspense, useCallback, useEffect, useMemo, useState } from "react";

// Import educational slides for this level
import PerceptionTasksSlide from "./slidesPerception/04-PerceptionTasks";
...
const SLIDES = [
  {
    ...
    Component: PerceptionTasksSlide,
  },
];

export default function PerceptionTasks({ onObjectiveHit, onLevelCompleted }) {
