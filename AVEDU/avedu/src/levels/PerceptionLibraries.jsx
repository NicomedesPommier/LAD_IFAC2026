// src/levels/PerceptionLibraries.jsx
import React, { Suspense, useCallback, useEffect, useMemo, useState } from "react";

// Import educational slides for this level
import PerceptionLibrariesOverview from "./slidesPerception/01-PerceptionLibrariesOverview";
import OpenCVBasics from "./slidesPerception/01a-OpenCVBasics";
...
const SLIDES = [
  {
    ...
    Component: PerceptionLibrariesOverview,
  },
  {
    id: "opencv-basics",
    ...
    Component: OpenCVBasics,
  },
];

export default function PerceptionLibraries({ onObjectiveHit, onLevelCompleted }) {
