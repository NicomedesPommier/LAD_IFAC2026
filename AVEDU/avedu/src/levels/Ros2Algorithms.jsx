// src/levels/Ros2Algorithms.jsx
import React, { Suspense, useCallback, useEffect, useMemo, useState } from "react";

// Import slides for Algorithms for Unreliable Conditions level
import HeartbeatPattern from "./slidesROS2Advanced/09-HeartbeatPattern";
import RetryStrategies from "./slidesROS2Advanced/10-RetryStrategies";
import MessageValidation from "./slidesROS2Advanced/11-MessageValidation";
import BufferingStrategies from "./slidesROS2Advanced/12-BufferingStrategies";
...
const SLIDES = [
  ...
  },
  {
    ...
    Component: BufferingStrategies,
  },
];

export default function Ros2Algorithms({ onObjectiveHit, onLevelCompleted }) {
