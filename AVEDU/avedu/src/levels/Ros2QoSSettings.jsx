// src/levels/Ros2QoSSettings.jsx
import React, { Suspense, useCallback, useEffect, useMemo, useState } from "react";

// Import slides for QoS Settings level
import ReliabilityPolicy from "./slidesROS2Advanced/04-ReliabilityPolicy";
import DurabilityHistory from "./slidesROS2Advanced/05-DurabilityHistory";
import TimingPolicies from "./slidesROS2Advanced/06-TimingPolicies";
...
const SLIDES = [
  ...
  },
  {
    ...
    Component: TimingPolicies,
  },
];

export default function Ros2QoSSettings({ onObjectiveHit, onLevelCompleted }) {
