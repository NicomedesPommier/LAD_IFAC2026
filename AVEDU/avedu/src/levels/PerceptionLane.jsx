// src/levels/PerceptionLane.jsx
import React, { Suspense, useCallback, useEffect, useMemo, useState } from "react";

// Import educational slides for this level
import LaneDetectionBasics from "./slidesPerception/03-LaneDetectionBasics";
import LaneDetectionInteractive from "./slidesPerception/03a-LaneDetectionInteractive";
...
const SLIDES = [
  ...
  },
  {
    ...
    order: 2,
    objectiveCode: "PERC_LANE_DETECT",
    Component: LaneDetectionInteractive,
  },
];

export default function PerceptionLane({ onObjectiveHit, onLevelCompleted }) {
